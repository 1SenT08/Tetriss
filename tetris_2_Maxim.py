...
#МАКСИИИИИИМ, ТЕПЕРЬ СДЛЕлай сжигание.
...
#        pygame.draw.rect(screen, pygame.Color(255, 255, 255), (self.left, self.top, self.size_square * 10, self.size_square * 20), 2)
    ...
    def view_figure(self):
        return [choice(figures), choice(colors)] # возвращает рандомную фигуру и цвет
...
def main():
    ...
    figur_ver = 0 # выставляю начальное вариант фигуры      Макс
    ...
    while running:
        ...
        if pos_y_figure + speed / fps <= size[1] - max_y_falling_figure and tetris.examination_bottom_coords(figure, # Проверяет упала ли фигура на блок или на стакан
                                                                                                         pos_x_figure,
                                                                                                         pos_y_figure + size_square,
